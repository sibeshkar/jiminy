...
from jiminy import rewarder, spaces, vectorized, pyprofile
from jiminy.utils import random_alphanumeric
...
class RecordingWriter(object):
    ...
    def __init__(self, recording_dir, instance_id, channel_id, async_write=True):
        self.log_fn = 'jiminy.recording.{}.{}.{}.jsonl'.format(os.getpid(), instance_id, channel_id)
        log_path = os.path.join(recording_dir, self.log_fn)
        self.bin_fn = 'jiminy.recording.{}.{}.{}.bin'.format(os.getpid(), instance_id, channel_id)
