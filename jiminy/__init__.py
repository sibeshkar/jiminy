...
def docker_image(runtime_id):
    logger.warn('DEPRECATION WARNING: jiminy.docker_image(runtime_id) is deprecated and will be removed soon. Use runtime_spec(runtime_id).image instead. ')
...
def enable_logfile(path=None):
    raise error.Error('Renamed to "jiminy.configure_logging()"')
...
def configure_logging(path=None):
    ...
    Set up log levels, and split verbose logs to a file
        ...
        verbose log file located at /tmp/jiminy-<pid>.log
    ...
    if path is False:
        ...
        path = '/tmp/jiminy-{}.log'.format(os.getpid())
...
register(
    ...
    entry_point='jiminy.wrappers:WrappedGymCoreEnv',
    max_episode_steps=500,
    tags={
        'vnc': True,
        'runtime': 'gym-core',
...
# Please keep this registry mirrored with the benchmarks in jiminy-envs/flashgames/gym_flashgames/__init__.py
# You can use jiminy-envs/flashgames/bin/manage export_env_ids_for_registration to generate this list.
for game in [
    ...
    register(
        id=game,
        entry_point='jiminy.wrappers:WrappedFlashgamesEnv',
...
register(
    ...
    entry_point='jiminy.vnc:WrappedFlashgamesEnv',
...
for game in vnc_world_of_bits:
    register(
        id=game,
        entry_point='jiminy.wrappers:WrappedVNCEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'wob': True,
...
for id in ['starcraft.TerranAstralBalance-v0']:
    register(
        id=id,
        entry_point='jiminy.wrappers:WrappedStarCraftEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'starcraft': True,
...
for gtav_game in ['gtav.SaneDriving-v0', 'gtav.Speed-v0']:
    register(
        id=gtav_game,
        entry_point='jiminy.wrappers:WrappedGTAVEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'gtav': True,
...
register(
    ...
    entry_point='jiminy.wrappers:WrappedWorldOfGooEnv',
    max_episode_steps=10**7,
    tags={
        'vnc': True,
        'wog': True,
...
for slith_game in ['SlitherIO-v0', 'SlitherIONoSkins-v0', 'SlitherIOEasy-v0']:
    register(
        ...
        entry_point='jiminy.wrappers:WrappedInternetEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'internet': True,
