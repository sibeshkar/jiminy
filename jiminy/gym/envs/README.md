...
from jiminy.gym.envs import mujoco
mujoco.AntEnv
```
...
from jiminy.gym.envs.mujoco import ant
ant.AntEnv
```
...
* `gym-foo/gym_foo/envs/__init__.py` should have:
  ```python
  from jiminy.gym_foo.envs.foo_env import FooEnv
  from jiminy.gym_foo.envs.foo_extrahard_env import FooExtraHardEnv
  ```

* `gym-foo/gym_foo/envs/foo_env.py` should look something like:
  ```python
  import jiminy.gym as gym
  from jiminy.gym import error, spaces, utils
  from jiminy.gym.utils import seeding
...
2. Import your environment into the `__init__.py` file of the collection. This file will be located at `/gym/envs/my_collection/__init__.py`. Add `from jiminy.gym.envs.my_collection.my_awesome_env import MyEnv` to this file.
