...
if __name__ == '__main__':
    ...
    # http://allocator.sci.boxware-tech.com?n=2
    parser.add_argument('-r', '--remote', default='http://allocator.sci.boxware-tech.com', help='The number of environments to create (e.g. -r 20), or the address of pre-existing VNC servers and rewarders to use (e.g. -r vnc://localhost:5900+15900,localhost:5901+15901), or a query to the allocator (e.g. -r http://allocator.sci.boxware-tech.com?n=2)')
    ...
    parser.add_argument('-d', '--docker-image', help='Force a version of the docker_image used with --remote <int>. e.g --docker-image quay.io/boxware/jiminy.gym-core:0.3')
